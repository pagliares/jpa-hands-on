...
public class CabinTest {
    ...
    public static void createCabin() {
        ...
        Ship ship = null;
        try {
            ship = shipController.findShip(shipID);
    ...
    public static void updateCabin() throws CabinNotFoundException {
        ...
        Integer newShipID = KeyboardInput.readInputAsInteger("Enter new ID of the Ship the cabin is located (" + cabin.getShip().getId()+")...: ");
        ...
        Ship ship = null;
        try {
            ship = shipController.findShip(newShipID);
        } catch (ShipNotFoundException shipNotFoundException) {
            System.out.println(shipNotFoundException.getMessage());
        }
        cabin.setShip(ship);
